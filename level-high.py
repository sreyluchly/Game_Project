...
# diamonds = []
# diamond_count = 0  # Variable to store the count of diamonds collected
...
#             print("Remaining diamonds:", len(diamonds))
#             print("Diamonds stored:", diamond_count)

#     print(canvas.coords(player))

# def create_diamond():
#     x = random.randint(0, canvas.winfo_width())  # Random X-coordinate of the diamond within the canvas width
#     y = random.randint(0, canvas.winfo_height())  # Random Y-coordinate of the diamond within the canvas height
#     diamond = canvas.create_image(x, y, image=pic_diamond)
#     diamonds.append(diamond)
#     print("Created a diamond!")

# root.bind("<Key>", move)
# root.bind("c", create_diamond)
# scroll_bg_image()
